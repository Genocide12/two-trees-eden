...
export const ACTIONS: Record<ActionId, ActionDef> = {
  ...
  miracle: {
    ...
    effects: { righteousness: 6, corruption: -3, population: 4, knowledge: 2 },
  ...
  prophet: {
    ...
    effects: { righteousness: 4, knowledge: 6, corruption: -2, population: 2 },
  ...
  heal: {
    ...
    effects: { population: 8, righteousness: 3, knowledge: 1, corruption: -1 },
  ...
  covenant: {
    ...
    effects: { righteousness: 7, knowledge: 4, population: 3, corruption: -4 },
  ...
  tempt: {
    ...
    effects: { corruption: 6, righteousness: -3, population: -2, knowledge: 1 },
  ...
  heresy: {
    ...
    effects: { corruption: 5, knowledge: 6, righteousness: -2, population: -1 },
  ...
  plague: {
    ...
    effects: { population: -10, corruption: 4, righteousness: -3, knowledge: 2 },
  ...
  deceit: {
    ...
    effects: { corruption: 7, righteousness: -4, knowledge: -1, population: -3 },
